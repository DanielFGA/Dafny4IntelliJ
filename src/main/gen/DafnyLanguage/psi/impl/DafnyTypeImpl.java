...
public interface DafnyTypeImpl {
  ...
  IElementType UNARY_EXPRESSION_2 = new DafnyElementType("UNARY_EXPRESSION_2");
  ...
  IElementType ALTERNATIVEBLOCKCASE_1_3_0 = new DafnyTokenType("AlternativeBlockCase_1_3_0");
  ...
  IElementType DIV = new DafnyTokenType("regexpr:\\/");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == UNARY_EXPRESSION_2) {
        return new DafnyUnaryExpression2Impl(node);
      }
