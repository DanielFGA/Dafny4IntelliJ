...
public class DafnyObjectExpressionImpl extends ASTWrapperPsiElement implements DafnyObjectExpression {

  public DafnyObjectExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
