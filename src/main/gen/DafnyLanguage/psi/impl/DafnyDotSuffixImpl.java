...
public class DafnyDotSuffixImpl extends ASTWrapperPsiElement implements DafnyDotSuffix {

  public DafnyDotSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiElement getDecimaldigits() {
    return findChildByType(DECIMALDIGITS);
  }
