...
public class DafnyParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // case (ExistentialGuard |  ConstAtomExpression | Expression |) darrow (Stmt)*
  ...
  // ExistentialGuard |  ConstAtomExpression | Expression |
  private static boolean AlternativeBlockCase_1(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, ALTERNATIVEBLOCKCASE_1_3_0);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  public static boolean AssertStmt(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<assert stmt>", ASSERT, ELLIPSIS)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ASSERT_STMT, "<assert stmt>");
    r = AssertStmt_0(b, l + 1);
    if (!r) r = parseTokens(b, 0, ELLIPSIS, SEMI);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // assert (Attribute)* (LabelIdent colon)? Expression (semi|by BlockStmt)
  private static boolean AssertStmt_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, ASSERT);
    r = r && AssertStmt_0_1(b, l + 1);
    r = r && AssertStmt_0_2(b, l + 1);
    r = r && Expression(b, l + 1);
    r = r && AssertStmt_0_4(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (Attribute)*
  private static boolean AssertStmt_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!AssertStmt_0_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "AssertStmt_0_1", c)) break;
    }
    return true;
  }

  // (Attribute)
  private static boolean AssertStmt_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = Attribute(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // (LabelIdent colon)?
  private static boolean AssertStmt_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0_2")) return false;
    AssertStmt_0_2_0(b, l + 1);
    return true;
  }

  // LabelIdent colon
  private static boolean AssertStmt_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = LabelIdent(b, l + 1);
  ...
  // semi|by BlockStmt
  private static boolean AssertStmt_0_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, SEMI);
    if (!r) r = AssertStmt_0_4_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // by BlockStmt
  private static boolean AssertStmt_0_4_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AssertStmt_0_4_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, BY);
    r = r && BlockStmt(b, l + 1);
  ...
  public static boolean BitvectorFactor(PsiBuilder b, int l) {
    ...
    r = BitvectorFactor_0(b, l + 1);
    if (!r) r = BitvectorFactor_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  //     )
  //  )?
  private static boolean BitvectorFactor_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = AsExpression(b, l + 1);
    r = r && BitvectorFactor_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  //     )
  //  )?
  private static boolean BitvectorFactor_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1")) return false;
    BitvectorFactor_0_1_0(b, l + 1);
    return true;
  }
  ...
  //          | verticalbar AsExpression (verticalbar AsExpression )*
  //          | "^" AsExpression ( "^" AsExpression)*
  private static boolean BitvectorFactor_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = BitvectorFactor_0_1_0_0(b, l + 1);
    if (!r) r = BitvectorFactor_0_1_0_1(b, l + 1);
    if (!r) r = BitvectorFactor_0_1_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // "&"  AsExpression ( "&" AsExpression)*
  private static boolean BitvectorFactor_0_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "&");
    r = r && AsExpression(b, l + 1);
    r = r && BitvectorFactor_0_1_0_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // ( "&" AsExpression)*
  private static boolean BitvectorFactor_0_1_0_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_0_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!BitvectorFactor_0_1_0_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "BitvectorFactor_0_1_0_0_2", c)) break;
    }
    return true;
  }

  // "&" AsExpression
  private static boolean BitvectorFactor_0_1_0_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "&");
    r = r && AsExpression(b, l + 1);
  ...
  // verticalbar AsExpression (verticalbar AsExpression )*
  private static boolean BitvectorFactor_0_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, VERTICALBAR);
    r = r && AsExpression(b, l + 1);
    r = r && BitvectorFactor_0_1_0_1_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (verticalbar AsExpression )*
  private static boolean BitvectorFactor_0_1_0_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_1_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!BitvectorFactor_0_1_0_1_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "BitvectorFactor_0_1_0_1_2", c)) break;
    }
    return true;
  }

  // verticalbar AsExpression
  private static boolean BitvectorFactor_0_1_0_1_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_1_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, VERTICALBAR);
    r = r && AsExpression(b, l + 1);
  ...
  // "^" AsExpression ( "^" AsExpression)*
  private static boolean BitvectorFactor_0_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "^");
    r = r && AsExpression(b, l + 1);
    r = r && BitvectorFactor_0_1_0_2_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // ( "^" AsExpression)*
  private static boolean BitvectorFactor_0_1_0_2_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_2_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!BitvectorFactor_0_1_0_2_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "BitvectorFactor_0_1_0_2_2", c)) break;
    }
    return true;
  }

  // "^" AsExpression
  private static boolean BitvectorFactor_0_1_0_2_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_0_1_0_2_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "^");
    r = r && AsExpression(b, l + 1);
  ...
  private static boolean BitvectorFactor_1(PsiBuilder b, int l) {
    ...
    r = consumeToken(b, VERTICALBAR);
    r = r && AsExpression(b, l + 1);
    r = r && BitvectorFactor_1_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (verticalbar AsExpression )*
  private static boolean BitvectorFactor_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_1_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!BitvectorFactor_1_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "BitvectorFactor_1_2", c)) break;
    }
    return true;
  }

  // verticalbar AsExpression
  private static boolean BitvectorFactor_1_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BitvectorFactor_1_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, VERTICALBAR);
    r = r && AsExpression(b, l + 1);
  ...
  /* ********************************************************** */
  // EquivExpression | EquivExpression (semi Expression)?
  ...
  /* ********************************************************** */
  // LogicalExpression (ImpliesOp ImpliesExpression)? | LogicalExpression
  public static boolean ImpliesExpression(PsiBuilder b, int l) {
    ...
    r = ImpliesExpression_0(b, l + 1);
    if (!r) r = LogicalExpression(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // LogicalExpression (ImpliesOp ImpliesExpression)?
  private static boolean ImpliesExpression_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ImpliesExpression_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = LogicalExpression(b, l + 1);
    r = r && ImpliesExpression_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (ImpliesOp ImpliesExpression)?
  private static boolean ImpliesExpression_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ImpliesExpression_0_1")) return false;
    ImpliesExpression_0_1_0(b, l + 1);
    return true;
  }

  // ImpliesOp ImpliesExpression
  private static boolean ImpliesExpression_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ImpliesExpression_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = ImpliesOp(b, l + 1);
    r = r && ImpliesExpression(b, l + 1);
  ...
  /* ********************************************************** */
  // ( WildIdent Suffix* | openparen ( IdentTypeOptional (comma IdentTypeOptional)* )? closeparen Suffix*)
  ...
  // WildIdent Suffix*
  private static boolean LambdaExpression_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LambdaExpression_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = WildIdent(b, l + 1);
    r = r && LambdaExpression_0_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean LambdaExpression_0_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LambdaExpression_0_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "LambdaExpression_0_0_1", c)) break;
    }
    return true;
  }

  // openparen ( IdentTypeOptional (comma IdentTypeOptional)* )? closeparen Suffix*
  private static boolean LambdaExpression_0_1(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, CLOSEPAREN);
    r = r && LambdaExpression_0_1_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // Suffix*
  private static boolean LambdaExpression_0_1_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LambdaExpression_0_1_3")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "LambdaExpression_0_1_3", c)) break;
    }
    return true;
  }
  ...
  private static boolean LambdaExpression_2(PsiBuilder b, int l) {
    ...
    LambdaExpression_2_0(b, l + 1);
    return true;
  }

  // LambdaArrow Expression
  private static boolean LambdaExpression_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LambdaExpression_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = LambdaArrow(b, l + 1);
    r = r && Expression(b, l + 1);
  ...
  /* ********************************************************** */
  // IdentTypeOptional (comma IdentTypeOptional)* (Attribute)* (verticalbar Expression)?
  ...
  private static boolean QuantifierDomain_3(PsiBuilder b, int l) {
    ...
    QuantifierDomain_3_0(b, l + 1);
    return true;
  }

  // verticalbar Expression
  private static boolean QuantifierDomain_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "QuantifierDomain_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, VERTICALBAR);
    r = r && Expression(b, l + 1);
  ...
  public static boolean RelOp(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, CLOSEANGLEBRACKET);
    if (!r) r = consumeToken(b, DARROW);
    if (!r) r = RelOp_6(b, l + 1);
    if (!r) r = consumeToken(b, IN);
    if (!r) r = consumeToken(b, NOTIN);
    if (!r) r = RelOp_9(b, l + 1);
    if (!r) r = consumeToken(b, "neqAlt");
    if (!r) r = consumeToken(b, "\\u2264");
    if (!r) r = consumeToken(b, "\\u2265");
    exit_section_(b, l, m, r, false, null);
  ...
  // neq ("#" lbracket Expression rbracket)?
  private static boolean RelOp_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelOp_6")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // ("#" lbracket Expression rbracket)?
  private static boolean RelOp_6_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelOp_6_1")) return false;
    RelOp_6_1_0(b, l + 1);
    return true;
  }

  // "#" lbracket Expression rbracket
  private static boolean RelOp_6_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelOp_6_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "#");
    r = r && consumeToken(b, LBRACKET);
  ...
  // "!" ("!")?
  private static boolean RelOp_9(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelOp_9")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "!");
    r = r && RelOp_9_1(b, l + 1);
  ...
  // ("!")?
  private static boolean RelOp_9_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelOp_9_1")) return false;
    RelOp_9_1_0(b, l + 1);
    return true;
  }

  // ("!")
  private static boolean RelOp_9_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelOp_9_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "!");
    exit_section_(b, m, null, r);
  ...
  /* ********************************************************** */
  // ShiftTerm (RelOp ShiftTerm (RelOp ShiftTerm)* )? | ShiftTerm
  ...
  private static boolean RelationalExpression_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = ShiftTerm(b, l + 1);
    r = r && RelationalExpression_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (RelOp ShiftTerm (RelOp ShiftTerm)* )?
  private static boolean RelationalExpression_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelationalExpression_0_1")) return false;
    RelationalExpression_0_1_0(b, l + 1);
    return true;
  }

  // RelOp ShiftTerm (RelOp ShiftTerm)*
  private static boolean RelationalExpression_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelationalExpression_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = RelOp(b, l + 1);
    r = r && ShiftTerm(b, l + 1);
    r = r && RelationalExpression_0_1_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (RelOp ShiftTerm)*
  private static boolean RelationalExpression_0_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelationalExpression_0_1_0_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!RelationalExpression_0_1_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "RelationalExpression_0_1_0_2", c)) break;
    }
    return true;
  }

  // RelOp ShiftTerm
  private static boolean RelationalExpression_0_1_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "RelationalExpression_0_1_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = RelOp(b, l + 1);
    r = r && ShiftTerm(b, l + 1);
  ...
  //              | colon (Expression (colon Expression)* (colon)? )?
  //              | (comma Expression)*
  private static boolean Suffix_0_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = Suffix_0_1_0_1_0(b, l + 1);
    if (!r) r = Suffix_0_1_0_1_1(b, l + 1);
    if (!r) r = Suffix_0_1_0_1_2(b, l + 1);
    if (!r) r = Suffix_0_1_0_1_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // twoDots (Expression)?
  private static boolean Suffix_0_1_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, TWODOTS);
    r = r && Suffix_0_1_0_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (Expression)?
  private static boolean Suffix_0_1_0_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_0_1")) return false;
    Suffix_0_1_0_1_0_1_0(b, l + 1);
    return true;
  }

  // (Expression)
  private static boolean Suffix_0_1_0_1_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = Expression(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  // gets Expression
  private static boolean Suffix_0_1_0_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, GETS);
    r = r && Expression(b, l + 1);
  ...
  // colon (Expression (colon Expression)* (colon)? )?
  private static boolean Suffix_0_1_0_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COLON);
    r = r && Suffix_0_1_0_1_2_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (Expression (colon Expression)* (colon)? )?
  private static boolean Suffix_0_1_0_1_2_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_2_1")) return false;
    Suffix_0_1_0_1_2_1_0(b, l + 1);
    return true;
  }

  // Expression (colon Expression)* (colon)?
  private static boolean Suffix_0_1_0_1_2_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_2_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = Expression(b, l + 1);
    r = r && Suffix_0_1_0_1_2_1_0_1(b, l + 1);
    r = r && Suffix_0_1_0_1_2_1_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (colon Expression)*
  private static boolean Suffix_0_1_0_1_2_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_2_1_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix_0_1_0_1_2_1_0_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "Suffix_0_1_0_1_2_1_0_1", c)) break;
    }
    return true;
  }

  // colon Expression
  private static boolean Suffix_0_1_0_1_2_1_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_2_1_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COLON);
    r = r && Expression(b, l + 1);
  ...
  // (colon)?
  private static boolean Suffix_0_1_0_1_2_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_2_1_0_2")) return false;
    consumeToken(b, COLON);
    return true;
  }

  // (comma Expression)*
  private static boolean Suffix_0_1_0_1_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_3")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix_0_1_0_1_3_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "Suffix_0_1_0_1_3", c)) break;
    }
    return true;
  }

  // comma Expression
  private static boolean Suffix_0_1_0_1_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_0_1_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && Expression(b, l + 1);
  ...
  private static boolean Suffix_0_1_1_1(PsiBuilder b, int l) {
    ...
    Suffix_0_1_1_1_0(b, l + 1);
    return true;
  }

  // (Expression)
  private static boolean Suffix_0_1_1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_0_1_1_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = Expression(b, l + 1);
    exit_section_(b, m, null, r);
  ...
  private static boolean Suffix_2_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = Suffix_2_1_0(b, l + 1);
    if (!r) r = Suffix_2_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean Suffix_2_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_2_1_0_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix_2_1_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "Suffix_2_1_0_2", c)) break;
    }
    return true;
  }

  // comma MemberBindingUpdate
  private static boolean Suffix_2_1_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_2_1_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && MemberBindingUpdate(b, l + 1);
  ...
  // DotSuffix (GenericInstantiation|HashCall)?
  private static boolean Suffix_2_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_2_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = DotSuffix(b, l + 1);
    r = r && Suffix_2_1_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (GenericInstantiation|HashCall)?
  private static boolean Suffix_2_1_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_2_1_1_1")) return false;
    Suffix_2_1_1_1_0(b, l + 1);
    return true;
  }

  // GenericInstantiation|HashCall
  private static boolean Suffix_2_1_1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Suffix_2_1_1_1_0")) return false;
    boolean r;
    r = GenericInstantiation(b, l + 1);
    if (!r) r = HashCall(b, l + 1);
    return r;
  ...
  //       | MultiSetExpr Suffix*
  //       | ConstAtomExpression Suffix*
  public static boolean UnaryExpression2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, UNARY_EXPRESSION_2, "<unary expression 2>");
    r = UnaryExpression2_0(b, l + 1);
    if (!r) r = UnaryExpression2_1(b, l + 1);
    if (!r) r = UnaryExpression2_2(b, l + 1);
    if (!r) r = UnaryExpression2_3(b, l + 1);
    if (!r) r = UnaryExpression2_4(b, l + 1);
    if (!r) r = EndlessExpression(b, l + 1);
    if (!r) r = UnaryExpression2_6(b, l + 1);
    if (!r) r = UnaryExpression2_7(b, l + 1);
    if (!r) r = UnaryExpression2_8(b, l + 1);
    if (!r) r = UnaryExpression2_9(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // minus UnaryExpression
  private static boolean UnaryExpression2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, MINUS);
    r = r && UnaryExpression(b, l + 1);
  ...
  // NegOp UnaryExpression
  private static boolean UnaryExpression2_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = NegOp(b, l + 1);
    r = r && UnaryExpression(b, l + 1);
  ...
  // map MapDisplayExpr Suffix*
  private static boolean UnaryExpression2_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, MAP);
    r = r && MapDisplayExpr(b, l + 1);
    r = r && UnaryExpression2_2_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_2_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_2_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_2_2", c)) break;
    }
    return true;
  }

  // imap MapDisplayExpr Suffix*
  private static boolean UnaryExpression2_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, IMAP);
    r = r && MapDisplayExpr(b, l + 1);
    r = r && UnaryExpression2_3_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_3_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_3_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_3_2", c)) break;
    }
    return true;
  }

  // iset ISetDisplayExpr Suffix*
  private static boolean UnaryExpression2_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, ISET);
    r = r && ISetDisplayExpr(b, l + 1);
    r = r && UnaryExpression2_4_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_4_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_4_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_4_2", c)) break;
    }
    return true;
  }

  // NameSegment Suffix*
  private static boolean UnaryExpression2_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_6")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = NameSegment(b, l + 1);
    r = r && UnaryExpression2_6_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_6_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_6_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_6_1", c)) break;
    }
    return true;
  }

  // DisplayExpr Suffix*
  private static boolean UnaryExpression2_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_7")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = DisplayExpr(b, l + 1);
    r = r && UnaryExpression2_7_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_7_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_7_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_7_1", c)) break;
    }
    return true;
  }

  // MultiSetExpr Suffix*
  private static boolean UnaryExpression2_8(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_8")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = MultiSetExpr(b, l + 1);
    r = r && UnaryExpression2_8_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_8_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_8_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_8_1", c)) break;
    }
    return true;
  }

  // ConstAtomExpression Suffix*
  private static boolean UnaryExpression2_9(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_9")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = ConstAtomExpression(b, l + 1);
    r = r && UnaryExpression2_9_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // Suffix*
  private static boolean UnaryExpression2_9_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "UnaryExpression2_9_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!Suffix(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "UnaryExpression2_9_1", c)) break;
    }
    return true;
  }
  ...
  // gets Rhs (comma Rhs)* | boredSmiley (assume)? Expression
